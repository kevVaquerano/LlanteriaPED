...
namespace Login2
{
    public partial class Dashboard : Form
    {
        ...
        private void LoadUserData()
        {
            ...
            string connectionString = "Server=roundhouse.proxy.rlwy.net;Port=31516;Database=railway;Uid=root;Pwd=xlwXNAGamSGbDHSjYCYpKbIzHLPZusup;";
        ...
        {
            FormAdd ir = new FormAdd();
            ir.Show();
        }

        private void button6_Click_1(object sender, EventArgs e)
        {
            FormEdit ir = new FormEdit();
            ir.Show();
        }
    }
